 ...
 ***************************************************/
#define DISPLAY_DIMMING_MODE  // uncomment this define to enable dimming function otherwise there is an on/off switching
                              // function
 ...
 **********************************************************/
#define SET_DISPL_SPI_BAUDRATE                  \
  DISPL_SPI->CR1 &= (uint16_t) ~SPI_CR1_BR_Msk; \
  DISPL_SPI->CR1 |= DISPL_PRESCALER

#define SET_TOUCH_SPI_BAUDRATE                  \
  TOUCH_SPI->CR1 &= (uint16_t) ~SPI_CR1_BR_Msk; \
